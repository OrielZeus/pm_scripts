...
$data["END_DOCUMENT_GENERATED_TYPE"] = "DRAFT";
//set initial message
$data['YQP_ERROR_SLIP'] = "";
//GET API TOKEN
...
if (!empty($data['END_UPLOAD_DRAFT_SUBMIT'])) {
    //Comments Approve
    $data['END_COMMENTS_APPROVE_ENDORSEMENT'] = "";
    //Submit Approve
    $data['END_FLOW_DRAFT_ENDORSEMENT'] = "";
    //Id document Upload
    $data['END_UPLOAD_DRAFT_ENDORSEMENT'] = "";
    //Approve Sr. underwriter
    $data['END_APPROVE_DRAFT_UPLOAD_ENDORSEMENT'] = "";  
}
//Clean Variables to download Draft Endorsement document
