...
$finalSubmitter     = (isset($data["FINAL_SUBMITTER"]) AND $data["FINAL_SUBMITTER"] != null AND $data["FINAL_SUBMITTER"] != "") ? $data["FINAL_SUBMITTER"] : $data['IN_IS03_CURRENT_USER']['fullname'];
$finalSubmitterDate = (isset($data["FINAL_SUBMITTER_DATE"]) AND $data["FINAL_SUBMITTER_DATE"] != null AND $data["FINAL_SUBMITTER_DATE"] != "") ? $data["FINAL_SUBMITTER_DATE"] : $currentDate;

return [
    "FINAL_SUBMITTER" => $finalSubmitter,
    "FINAL_SUBMITTER_DATE" => $finalSubmitterDate,
