...
$vendorLabelSafe = preg_replace('/[^A-Za-z0-9_\-]/', '_', $data["vendorInformation"][0]["VENDOR_LABEL"]);
$invoiceNumberSafe = preg_replace('/[^A-Za-z0-9_\-]/', '_', $data["IN_INVOICE_NUMBER"]);
$pdfName = $vendorLabelSafe . "_" . $invoiceNumberSafe . ".pdf";
...
if(!isset($data['corporateFX']) OR !$data['corporateFX']){
...
if(isset($data['IN_FX_TOTAL_AMOUNT']) AND $data['IN_FX_TOTAL_AMOUNT'] != ''){
  //Save comments into collection
  $dataRecord = [
      "IN_CL_CASE_NUMBER" => $data['_request']['case_number'],
      "IN_CL_REQUEST_ID" => $data['_request']['id'],
      "IN_CL_USER" => $data["commentsData"]["userName"],
      "IN_CL_USER_ID" => $data["commentsData"]["userID"],
      "IN_CL_ROLE" => 'Corporate Finance Analyst FX',
      "IN_CL_ROLE_ID" => 2,
      "IN_CL_APPROVAL" => '',
      "IN_CL_COMMENT_SAVED" => empty($data["IN_COMMENT_FX_CO"]) ? "" : $data["IN_COMMENT_FX_CO"],
      "IN_CL_DATE" => date("m/d/Y H:i:s"),
      "IN_SUBMIT" => null
  ];
  $getResponse = postRecordToCollection($dataRecord, getCollectionId("IN_COMMENTS_LOG", $apiUrl));
...
return array(
  "IN_FINAL_PDF_URL" => $fileGeneratedUrl,
  "IN_FINAL_PDF_ID" => $fileUID
);
...
function generatePDF($outputDocumentTempPath, $data, $documentsNames, $serverUrl)
{
  ...
  //1st page portrait
  $pdfHTML .= "<page orientation='P' backtop='10mm' backbottom='10mm' backleft='10mm' backright='10mm'>";
        ...
        $pdfHTML .= "<table style='width:100%'>";
          ...
          $pdfHTML .= "</tr>";
          $pdfHTML .= addSectionTitle("Invoice Summary");
        ...
        $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Case Title:</td>";
            $pdfHTML .= "<td class='text'  style='width:70%;'><strong>" . $data["IN_CASE_REFERENCE"] . "</strong></td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Case Number:</td>";
            $pdfHTML .= "<td class='text'  style='width:70%;'>" . $data["_request"]["case_number"] . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label'  style='width:30%;'>Invoice Date:</td>";
            $pdfHTML .= "<td class='text'  style='width:70%;'>" . formatDate($data["IN_INVOICE_DATE"], "m/d/Y") . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Invoice Number:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["IN_INVOICE_NUMBER"] . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Invoice Currency:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["IN_INVOICE_CURRENCY"] . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Invoice Total:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . number_format($data["IN_INVOICE_TOTAL"], 2, '.', ',') . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Vendor:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["vendorInformation"][0]["VENDOR_LABEL"] . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Vendor ID:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["IN_INVOICE_VENDOR_ID"] . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Vendor Address:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["IN_INVOICE_VENDOR_ADDRESS"] . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Vendor Location:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["vendorInformation"]["vendorLocation"] . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Comments:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["IN_INVOICE_TRANS_COMMENTS"] . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Company:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["vendorInformation"]["companyData"] . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>FX Required:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["IN_FX_REQUIRED"] . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>FX Rate:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["IN_FX_RATE"] . "</td>";
          $pdfHTML .= "</tr>";
          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Settlement Currency:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . $data["IN_FX_CURRENCY"] . "</td>";
          $pdfHTML .= "</tr>";
          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Settlement Amount:</td>";
            if ($data["IN_FX_TOTAL_AMOUNT"] == 0 || $data["IN_FX_TOTAL_AMOUNT"] === null) {
              $pdfHTML .= "<td class='text' style='width:70%;'></td>";
            } else {
              $pdfHTML .= "<td class='text' style='width:70%;'>" . number_format($data["IN_FX_TOTAL_AMOUNT"], 2, '.', ',') . "</td>";
            }
        ...
        $pdfHTML .= "<tr>";
          ...
          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>PDF Invoice:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . setDocumentLink($processRequestId, $data["IN_UPLOAD_PDF"], "", $serverUrl, $documentsNames) . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Excel Invoice:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . setDocumentLink($processRequestId, $data["IN_UPLOAD_EXCEL"], "", $serverUrl, $documentsNames) . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>Additional Documents:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . setDocumentLink($processRequestId, $data["IN_ADDITIONAL_FILES"], "", $serverUrl, $documentsNames) . "</td>";
          $pdfHTML .= "</tr>";

          $pdfHTML .= "<tr>";
            $pdfHTML .= "<td class='label' style='width:30%;'>FX Document:</td>";
            $pdfHTML .= "<td class='text' style='width:70%;'>" . setDocumentLink($processRequestId, $data["IN_FX_UPLOAD_FILE"], "", $serverUrl, $documentsNames) . "</td>";
          $pdfHTML .= "</tr>";
          $pdfHTML .= "</table>";
...
$pdfHTML .= "</table>";
 ...
 // $pdfHTML .= "</page>";
  // 3rd page portrait
 // $pdfHTML .= "<page orientation='P'>";
        $pdfHTML .= "<br><br><br>";
        $pdfHTML .= "<table style='border-collapse:collapse; table-layout: fixed; width: 100%;'>";

        $pdfHTML .= addSectionTitle('History of Comments');
        ...
        $pdfHTML .= "<table style='border-collapse:collapse; width:100%'>";
          $pdfHTML .= "<tr>";
            ...
            $pdfHTML .= "<th class='titleGrid' style='width:20%'>Role</th>";
            $pdfHTML .= "<th class='titleGrid' style='width:20%'>Approval</th>";
            $pdfHTML .= "<th class='titleGrid' style='width:30%'>Comments</th>";
            $pdfHTML .= "<th class='titleGrid' style='width:10%'>Date</th>";
          $pdfHTML .= "</tr>";
          foreach ($data['IN_COMMENTS_HISTORY'] as $item) {
            $pdfHTML .= "<tr>";
              $pdfHTML .= "<td class='textGrid' style='width:20%'>" . $item["IN_CL_USER"] . "</td>";
              $pdfHTML .= "<td class='textGrid' style='width:20%'>" . $item["IN_CL_ROLE"] . "</td>";
              $pdfHTML .= "<td class='textGrid' style='width:20%'>" . ($item["IN_CL_APPROVAL"] ?? "") . "</td>";
              $pdfHTML .= "<td class='textGrid' style='width:30%'>" . ($item["IN_CL_COMMENT_SAVED"] ?? "") . "</td>";
              $pdfHTML .= "<td class='textGrid' style='width:10%'>" . formatDate($item["IN_CL_DATE"], "m/d/Y"). "</td>";
            $pdfHTML .= "</tr>";
          }
        $pdfHTML .= "</table>";
  ...
  // 2nd page landscape
  $pdfHTML .= "<page orientation='L' backtop='15mm' backbottom='10mm' backleft='5mm' backright='5mm'>";
        $pdfHTML .= "<table style='width:100%'>";
    ...
    $pdfHTML .= "</table>";
        ...
        $pdfHTML .= "<tr split='true' style='page-break-inside: avoid; page-break-after: auto;'>";
          ...
          foreach ($data['IN_EXPENSE_TABLE'] as $item) {
            $pdfHTML .= "<tr split='true' style='page-break-inside: avoid; page-break-after: auto;'>";
              $pdfHTML .= "<td split='true' class='lineItems' style='width:2%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_TEAM_ROW_INDEX"] . "</td>";    
              $pdfHTML .= "<td split='true' class='lineItems' style='width:20%; word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_DESCRIPTION"] . "</td>";
              $pdfHTML .= "<td split='true' class='lineItems' style='width:6%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . nl2br(htmlspecialchars(preg_replace('/([;_-])/', ' ', $item["IN_EXPENSE_NR_LABEL"]))) . "</td>";      
              $pdfHTML .= "<td split='true' class='lineItems' style='width:6%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_TEAM_ROUTING_LABEL"] . "</td>";    
              $pdfHTML .= "<td split='true' class='lineItems' style='width:4%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_ACCOUNT_LABEL"] . "</td>";        
              $pdfHTML .= "<td split='true' class='lineItems' style='width:3%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . number_format($item["IN_EXPENSE_PRETAX_AMOUNT"], 2, '.', ',') . "</td>";   
              $pdfHTML .= "<td split='true' class='lineItems' style='width:3%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . number_format($item["IN_EXPENSE_HST"], 2, '.', ',') . "</td>";         
              $pdfHTML .= "<td split='true' class='lineItems' style='width:3%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . number_format($item["IN_EXPENSE_TOTAL"], 2, '.', ',') . "</td>";      
              $pdfHTML .= "<td split='true' class='lineItems' style='width:4%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_PERCENTAGE_TOTAL"] . "%</td>"; 
              $pdfHTML .= "<td split='true' class='lineItems' style='width:5%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_CORP_PROJ_LABEL"] . "</td>"; 
              $pdfHTML .= "<td split='true' class='lineItems' style='width:5%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_PROJECT_DEAL_LABEL"] . "</td>";   
              $pdfHTML .= "<td split='true' class='lineItems' style='width:5%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_FUND_MANAGER_LABEL"] . "</td>"; 
              $pdfHTML .= "<td split='true' class='lineItems' style='width:5%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_MANDATE_LABEL"] . "</td>"; 
              $pdfHTML .= "<td split='true' class='lineItems' style='width:5%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_ACTIVITY_LABEL"] . "</td>";
              $pdfHTML .= "<td split='true' class='lineItems' style='width:5%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_CORP_ENTITY_LABEL"] . "</td>";
              $pdfHTML .= "<td split='true' class='lineItems' style='width:5%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . nl2br(htmlspecialchars(preg_replace('/([;_-])/', ' ', $item["IN_EXPENSE_DEPARTMENT_LABEL"]))) . "</td>"; 
              $pdfHTML .= "<td split='true' class='lineItems' style='width:4%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . $item["IN_EXPENSE_OFFICE_LABEL"] . "</td>";         
              $pdfHTML .= "<td split='true' class='lineItems' style='width:10%;word-wrap: break-word; overflow-wrap: break-word; word-break: break-all;'>" . nl2br(htmlspecialchars(wordwrap($item["IN_EXPENSE_GL_CODE"], 28, ' ', true))) . "</td>";  
            $pdfHTML .= "</tr>";
          }
        $pdfHTML .= "</table>";
