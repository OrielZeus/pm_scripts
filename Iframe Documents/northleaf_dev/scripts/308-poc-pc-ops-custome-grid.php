...
$inTotalPreTaxAmountInitSubPc = stringToFloat($data['IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC']);
$inTotalHstInitSubPc = stringToFloat($data['IN_TOTAL_HST_INIT_SUB_PC']);
$inTotalTotalInitSubPc = stringToFloat($data['IN_TOTAL_TOTAL_INIT_SUB_PC']);
$inTotalPercentageTotalInitSubPc = stringToFloat($data['IN_TOTAL_PERCENTAGE_TOTAL_INIT_SUB_PC']);
$inInvoicePreTaxPercentageInitSubPc  = stringToFloat($data['IN_INVOICE_PRE_TAX_PERCENTAGE_INIT_SUB_PC']);
$inInvoiceTaxTotalPercentageInitSubPc  = stringToFloat($data['IN_INVOICE_TAX_TOTAL_PERCENTAGE_INIT_SUB_PC']);
$inInvoiceTotalPercentageInitSubPc  = stringToFloat($data['IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC']);
...
$inTotalPreTaxAmountInitSubPc   = empty($summaryTotal["IN_EXPENSE_PRETAX_AMOUNT"]) ? 0 : stringToFloat($summaryTotal["IN_EXPENSE_PRETAX_AMOUNT"]);
$inTotalHstInitSubPc            = empty($summaryTotal["IN_EXPENSE_HST"]) ? 0 : stringToFloat($summaryTotal["IN_EXPENSE_HST"]);
$inTotalTotalInitSubPc          = empty($summaryTotal["IN_EXPENSE_TOTAL"]) ? 0 : stringToFloat($summaryTotal["IN_EXPENSE_TOTAL"]);
	...
	<div id="app">
		<div v-cloak>
			...
			<div>
				...
				<!-- <h2>Team Table</h2> -->
				<h4 class="pm-text-primary">Invoice Private Credit Line Items</h4>
				<hr class="pm-text-primary">
				<div class="table-responsive" id="iframe-table-container" style="max-height: 800px;">
						<!-- <p>IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC: {{IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC}}</p>
						<p>IN_TOTAL_HST_INIT_SUB_PC: {{IN_TOTAL_HST_INIT_SUB_PC}}</p>
						<p>IN_TOTAL_TOTAL_INIT_SUB_PC: {{IN_TOTAL_TOTAL_INIT_SUB_PC}}</p>
						<p>IN_INVOICE_PRE_TAX_PERCENTAGE_INIT_SUB_PC: {{IN_INVOICE_PRE_TAX_PERCENTAGE_INIT_SUB_PC}}</p>
						<p>IN_TOTAL_PERCENTAGE_TOTAL_INIT_SUB_PC: {{IN_TOTAL_PERCENTAGE_TOTAL_INIT_SUB_PC}}</p>
						<p>IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC: {{IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC}}</p>
					...
					<table class="table table-bordered table-striped w-auto mb-4">
						<thead class="thead-light">
							<tr class="trBgWhite">
								...
								<th class="pm-bg-primary pm-text-white text-center">
									{{ formatNumber(IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC) }}
									<!-- <p class="text-info small">IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC</p> -->
								</th>
								<th class="pm-bg-primary pm-text-white text-center">
									{{ formatNumber(IN_TOTAL_HST_INIT_SUB_PC) }}
									<!-- <p class="text-info small">IN_TOTAL_HST_INIT_SUB_PC</p> -->
								</th>
								<th class="pm-bg-primary pm-text-white text-center">
									{{ formatNumber(IN_TOTAL_TOTAL_INIT_SUB_PC) }}
									<!-- <p class="text-info small">IN_TOTAL_TOTAL_INIT_SUB_PC</p> -->
								</th>
								<th></th>
								<th style="width:200px">
									<!-- <p class="text-info small">IN_TOTAL_PERCENTAGE_TOTAL_INIT_SUB_PC: {{IN_TOTAL_PERCENTAGE_TOTAL_INIT_SUB_PC}}</p> -->
								</th>
								<th style="width:200px">
									<!-- <p class="text-info small">IN_INVOICE_PRE_TAX_PERCENTAGE_INIT_SUB_PC: {{IN_INVOICE_PRE_TAX_PERCENTAGE_INIT_SUB_PC}}</p> -->
								</th>
								<th style="width:200px">
									<!-- <p class="text-info small">IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC: {{IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC}}</p> -->
								</th>
								<th style="width:200px"></th>
								<th style="width:200px"></th>
								<th colspan="3" style="width:200px"></th>
							...
							<tr class="head-table">
								...
								<th>Tax Amount</th>
								<th>Total Amount</th>
								<th>% of Total Private Credit Invoice Amount</th>
								<th style="width:200px">Corporate Project</th>
								<th style="width:200px">Deal</th>
								<th style="width:200px">Fund Manager</th>
								<th style="width:200px">Mandate</th>
						...
						<tfoot class="tfoot-light">
							<tr>
								...
								<td><strong>Total</strong></td>
								<td class="matching" 
									v-bind:class="cleanNumber(IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC) == cleanNumber(IN_TOTAL_PRE_TAX_AMOUNT) ? \'equal\' : \'different\'"
									style="text-align: right;padding-right: 1.3em;"
								>
									{{ formatNumber(IN_TOTAL_PRE_TAX_AMOUNT) }}
									<!-- <p class="text-info small">IN_TOTAL_PRE_TAX_AMOUNT: {{cleanNumber(IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC)}} == {{cleanNumber(IN_TOTAL_PRE_TAX_AMOUNT)}}</p> -->
								</td>
								<td class="matching" 
									v-bind:class="cleanNumber(IN_TOTAL_HST_INIT_SUB_PC) == cleanNumber(IN_TOTAL_HST) ? \'equal\' : \'different\'"
									style="text-align: right;padding-right: 1.3em;"
								>
									{{ formatNumber(IN_TOTAL_HST) }}
									<!-- <p class="text-info small">IN_TOTAL_HST: {{cleanNumber(IN_TOTAL_HST_INIT_SUB_PC)}} == {{cleanNumber(IN_TOTAL_HST)}}</p> -->
								</td>
								<td class="matching" 
									v-bind:class="cleanNumber(IN_TOTAL_TOTAL_INIT_SUB_PC) == cleanNumber(IN_TOTAL_TOTAL) ? \'equal\' : \'different\'"
									style="text-align: right;padding-right: 1.3em;"
								>
									{{ formatNumber(IN_TOTAL_TOTAL) }}
									<|input v-show="false" v-model="cleanNumber(IN_TOTAL_TOTAL)" id="iframe-totalFinalAmount" class="form-control">
									<!-- <p class="text-info small">IN_TOTAL_TOTAL: {{cleanNumber(IN_TOTAL_TOTAL_INIT_SUB_PC)}} == {{cleanNumber(IN_TOTAL_TOTAL)}}</p> -->
								</td>
								<!--td :class="{matching:true, equal: IN_TOTAL_PERCENTAGE_TOTAL==IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC, different: IN_TOTAL_PERCENTAGE_TOTAL!=IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC}"
									style="text-align: right;padding-right: 1.3em;"
								>
									{{ formatPercentageNumber(IN_TOTAL_PERCENTAGE_TOTAL) }}
									<!-- <p class="text-info small">IN_TOTAL_PERCENTAGE_TOTAL: {{IN_TOTAL_PERCENTAGE_TOTAL}}</p> -->
								</td-->
								<td :class="{matching:true, equal: IN_TOTAL_PERCENTAGE_TOTAL==\'100.00\', different: IN_TOTAL_PERCENTAGE_TOTAL!=\'100.00\'}"
									style="text-align: right;padding-right: 1.3em;"
								>
									{{ formatPercentageNumber(IN_TOTAL_PERCENTAGE_TOTAL) }}
								</td>
				...
				<div style="width: 70%;">
					...
					<div class="alert alert-danger" role="alert" v-if="!isGridValid || gridError.error || fixDiscrepancyError || IN_OUTSTANDING_TOTAL_PRE_TAX_AMOUNT != 0 || IN_OUTSTANDING_TOTAL_HST != 0 || IN_OUTSTANDING_TOTAL != 0 || IN_OUTSTANDING_PERCENTAGE != 0">
						<ul>
							...
							<!--li v-if="IN_OUTSTANDING_PERCENTAGE != 0">The Total Percentage must be equal to {{ IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC }}%</li-->
	...
	// As a plugin
		new Vue({
			...
			data: {
				...
				totalPercentage: " . $inInvoiceTotalPercentageInitSubPc . ",
				//Final Values
			...
			methods: {
				...
				evaluateRow(index) {
					...
					let taxTotalPercentage = this.cleanNumber(this.IN_INVOICE_TAX_TOTAL_PERCENTAGE_INIT_SUB_PC);
					let invoicePreTaxPercentage = this.cleanNumber(this.IN_INVOICE_PRE_TAX_PERCENTAGE_INIT_SUB_PC);

					// Calc IN_EXPENSE_HST => ((IN_EXPENSE_PRETAX_AMOUNT * IN_INVOICE_TAX_TOTAL_PERCENTAGE_INIT_SUB_PC) / IN_INVOICE_PRE_TAX_PERCENTAGE_INIT_SUB_PC)
					...
					let itemPercentage = (parseFloat(this.cleanNumber(item.IN_EXPENSE_TOTAL)) * this.totalPercentage) / this.IN_TOTAL_TOTAL_INIT_SUB_PC;
				...
				addRow() {
					...
					this.items.push(
						{
							...
							IN_EXPENSE_TEAM_ROUTING: {ID: 'PC', LABEL: 'Private Credit'},
					...
					this.items[this.items.length-1]['IN_EXPENSE_TEAM_ROUTING'] = {ID: 'PC', LABEL: 'Private Credit'};
					this.onChangeTeamRouting(this.items.length-1, {ID: 'PC', LABEL: 'Private Credit'});
					this.calculateFinalTotals();
					this.areAllValid() ;
				},
				deleteRow(index) {
				...
				calculateFinalTotals() {
					...
					// Outstanding
					this.IN_OUTSTANDING_TOTAL_PRE_TAX_AMOUNT = (this.cleanNumber((this.cleanNumber(this.IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC) - this.cleanNumber(this.IN_TOTAL_PRE_TAX_AMOUNT)), true)).toFixed(2);
					this.IN_OUTSTANDING_TOTAL_HST = (this.cleanNumber((this.cleanNumber(this.IN_TOTAL_HST_INIT_SUB_PC) - this.cleanNumber(this.IN_TOTAL_HST)), true)).toFixed(2);
					this.IN_OUTSTANDING_TOTAL = (this.cleanNumber((this.cleanNumber(this.IN_TOTAL_TOTAL_INIT_SUB_PC) - this.cleanNumber(this.IN_TOTAL_TOTAL)), true)).toFixed(2);   
					//this.IN_OUTSTANDING_PERCENTAGE = (this.cleanNumber((this.IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC - this.cleanNumber(this.IN_TOTAL_PERCENTAGE_TOTAL)), true)).toFixed(2);
				...
				onBlurTotal(index, field) {
					if(!this.isDiscrepancyMode) {
						...
						// Calc IN_EXPENSE_PERCENTAGE_TOTAL = ((IN_EXPENSE_TOTAL  *  IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC)  /  IN_TOTAL_TOTAL_INIT_SUB_PC)
						let total = this.cleanNumber(item[field]);
						let perTotal  = (total * 100) / this.cleanNumber(this.IN_TOTAL_TOTAL_INIT_SUB_PC);
						item['IN_EXPENSE_PERCENTAGE_TOTAL'] = isNaN(perTotal) ? '0.00%' : this.formatPercentageNumber(perTotal);
						let expTotal  = (this.cleanNumber(this.IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC) * perTotal)/ 100;
						item['IN_EXPENSE_PRETAX_AMOUNT'] = isNaN(expTotal) ? '0.00' : this.formatNumber(expTotal);
						/*
						let invoiceTotalPercentage = this.cleanNumber(this.IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC);
						let invoiceTotal = this.cleanNumber(this.IN_TOTAL_TOTAL_INIT_SUB_PC);
						...
						// Calc IN_EXPENSE_PRETAX_AMOUNT = ((IN_EXPENSE_PERCENTAGE_TOTAL  *  IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC)  /  IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC) 
						let invoicePreTax = this.cleanNumber(this.IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC);
				...
				onBlurPercentageTotal(index, field) {
					if(!this.isDiscrepancyMode) {
						...
						let pretax  = (totalPer * this.cleanNumber(this.IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC)) / 100;
						item['IN_EXPENSE_PRETAX_AMOUNT'] = isNaN(pretax) ? '0.00' : this.formatNumber(pretax);
						let total  = (totalPer * this.cleanNumber(this.IN_TOTAL_TOTAL_INIT_SUB_PC)) / 100;
						...
						let prevExpensePercentageTotal = (prevTotal * this.cleanNumber(this.IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC) / this.cleanNumber(this.IN_TOTAL_TOTAL_INIT_SUB_PC));
						...
						// Calc IN_EXPENSE_TOTAL = ((IN_EXPENSE_PRETAX_AMOUNT  *  IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC)  /  IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC)
						//let preTaxAmountOld = this.cleanNumber(item['IN_EXPENSE_PRETAX_AMOUNT']);
						let invoicePreTaxPercentage = this.cleanNumber(this.IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC);
						let total = ((preTaxAmount * invoiceTotalPercentage)/ invoicePreTaxPercentage);
						//item['IN_EXPENSE_TOTAL'] = isNaN(total) ? '0.00' : this.formatNumber(total);


						// Calc the posible value of percentage_total
						// Temp cacl Calc IN_EXPENSE_PERCENTAGE_TOTAL = ((IN_EXPENSE_TOTAL  *  IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC)  /  IN_TOTAL_TOTAL_INIT_SUB_PC)
						let tempExpensePercentageTotal = (total * invoiceTotalPercentage / this.cleanNumber(this.IN_TOTAL_TOTAL_INIT_SUB_PC));
				...
				onBlurPreTaxAmount(index, field) {
					if(!this.isDiscrepancyMode) {
						...
						// Calc IN_EXPENSE_TOTAL = ((IN_EXPENSE_PRETAX_AMOUNT  *  IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_PC)  /  IN_INVOICE_PRE_TAX_PERCENTAGE_INIT_SUB_PC)
						let pretaxAmount = this.cleanNumber(item[field]);
						let perTotal  = (pretaxAmount * 100) / this.cleanNumber(this.IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_PC);
						item['IN_EXPENSE_PERCENTAGE_TOTAL'] = isNaN(perTotal) ? '0.00%' : this.formatPercentageNumber(perTotal);
						let expTotal  = (this.cleanNumber(this.IN_TOTAL_TOTAL_INIT_SUB_PC) * perTotal)/ 100;
			...
			mounted() {
				...
				if(Array.isArray(this.items)) {
					this.items.forEach((item, index) => {
						...
						//let perRow = (this.cleanNumber(item.IN_EXPENSE_TOTAL) * 100) / this.cleanNumber(this.IN_TOTAL_TOTAL_INIT_SUB_PC)
