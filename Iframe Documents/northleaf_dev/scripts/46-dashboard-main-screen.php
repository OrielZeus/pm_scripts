...
<script type='text/javascript'>
    ...
    */
    function showModalReapproval(caseNumber, caseTitle, dataToSave)
    {
        ...
        $('#case-selected').html(atob(caseTitle));
                ...
                },
                {
                    ...
                    'mRender': function (data, type, rowData) {
                        if (rowData[6] === true) { // USER_CAN_REAPPROVAL
                            ...
                            let showIcon = "<span class='iconClass' title='Reaproval Case' aria-hidden='true' onclick=\"showModalReapproval('" + rowData[0] + "', '"+ btoa(rowData[4]) +"', '"+ dataToSaveEncoded +"')\"><!DOCTYPE svg PUBLIC '-//W3C//DTD SVG 1.1//EN' 'http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd'><svg fill='#9b1012' height='24px' width='24px' version='1.1' id='Filled_Icons' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' x='0px' y='0px' viewBox='0 0 24 24' enable-background='new 0 0 24 24' xml:space='preserve'><g id='SVGRepo_bgCarrier' stroke-width='0'/><g id='SVGRepo_tracerCarrier' stroke-linecap='round' stroke-linejoin='round'/><g id='SVGRepo_iconCarrier'><g id='Rewind-Filled'><path d='M1.98,12L15,2v5.71L23,2v20l-8-5.71V22L1.98,12z'/></g></g></svg></span>";
                            return showIcon;
                        } else {
                            return '<span></span>';
                        }
