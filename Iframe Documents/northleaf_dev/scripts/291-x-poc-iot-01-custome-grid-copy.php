...
$items = transformData($enabledRows);
$disabledItems = transformData($disabledRows);
	...
	<div id="app">
		<div v-cloak>
			...
			<div>
							...
							<tr v-for="(disabledItem, index) in disabledItems" :key="disabledItems.IN_EXPENSE_ROW_NUMBER" >
								...
								<td style="min-width:300px">
									...
									<|textarea 
										...
										cols="10"
										disabled
										@change="isValidDescription(index, $event.target.value)"
									>
									</|textarea>
				...
				<!-- <h2>Team Table</h2> -->
				<h4 class="pm-text-primary">Invoice Infraestructure</h4>
					...
					<table class="table table-bordered table-striped w-auto mb-4">
						<thead class="thead-light">
							<tr class="">
								...
								<th class="pm-bg-primary pm-text-white text-center">
									{{ formatNumber(IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_INFRA) }}
									<!-- <p class="text-info small">IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_INFRA</p> -->
								</th>
								<th class="pm-bg-primary pm-text-white text-center">
									{{ formatNumber(IN_TOTAL_HST_INIT_SUB_INFRA) }}
									<!-- <p class="text-info small">IN_TOTAL_HST_INIT_SUB_INFRA</p> -->
								</th>
								<th class="pm-bg-primary pm-text-white text-center">
									{{ formatNumber(IN_TOTAL_TOTAL_INIT_SUB_INFRA) }}
									<!-- <p class="text-info small">IN_TOTAL_TOTAL_INIT_SUB_INFRA</p> -->
								</th>
								<th></th>
								<th style="width:200px">
									<!-- <p class="text-info small">IN_TOTAL_PERCENTAGE_TOTAL_INIT_SUB_INFRA: {{IN_TOTAL_PERCENTAGE_TOTAL_INIT_SUB_INFRA}}</p> -->
								</th>
								<th style="width:200px">
									<!-- <p class="text-info small">IN_INVOICE_PRE_TAX_PERCENTAGE_INIT_SUB_INFRA: {{IN_INVOICE_PRE_TAX_PERCENTAGE_INIT_SUB_INFRA}}</p> -->
								</th>
								<th style="width:200px">
									<!-- <p class="text-info small">IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_INFRA: {{IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_INFRA}}</p> -->
								</th>
								<th style="width:200px">
								</th>
								<th style="width:200px"></th>
						...
						<tfoot class="tfoot-light">
							<tr>
								...
								>
									{{ formatNumber(IN_TOTAL_PRE_TAX_AMOUNT) }}
									<!-- <p class="text-info small">IN_TOTAL_PRE_TAX_AMOUNT: {{cleanNumber(IN_TOTAL_PRE_TAX_AMOUNT_INIT_SUB_INFRA)}} == {{cleanNumber(IN_TOTAL_PRE_TAX_AMOUNT)}}</p> -->
								</td>
								<td class="matching" 
								...
								>
									{{ formatNumber(IN_TOTAL_HST) }}
									<!-- <p class="text-info small">IN_TOTAL_HST: {{cleanNumber(IN_TOTAL_HST_INIT_SUB_INFRA)}} == {{cleanNumber(IN_TOTAL_HST)}}</p> -->
								</td>
								<td class="matching" 
								...
								>
									{{ formatNumber(IN_TOTAL_TOTAL) }}
									<|input v-show="false" v-model="cleanNumber(IN_TOTAL_TOTAL)" id="iframe-totalFinalAmount" class="form-control">
									<!-- <p class="text-info small">IN_TOTAL_TOTAL: {{cleanNumber(IN_TOTAL_TOTAL_INIT_SUB_INFRA)}} == {{cleanNumber(IN_TOTAL_TOTAL)}}</p> -->
								</td>
								<td :class="{matching:true, equal: IN_TOTAL_PERCENTAGE_TOTAL==IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_INFRA, different: IN_TOTAL_PERCENTAGE_TOTAL!=IN_INVOICE_TOTAL_PERCENTAGE_INIT_SUB_INFRA}"
									style="text-align: right;padding-right: 1.3em;"
								>
									{{ formatPercentageNumber(IN_TOTAL_PERCENTAGE_TOTAL) }}
									<!-- <p class="text-info small">IN_TOTAL_PERCENTAGE_TOTAL: {{IN_TOTAL_PERCENTAGE_TOTAL}}</p> -->
