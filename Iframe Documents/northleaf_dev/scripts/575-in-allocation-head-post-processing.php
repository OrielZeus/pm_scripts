...
/*
if($data["SUBMIT_".$teamID."_H"] == "SUBMIT"){
    $comments = empty($data['IN_'.$teamID.'H_Comments']) ? "" : $data['IN_'.$teamID.'H_Comments'];
    $approval = empty($data["IN_".$teamID."H_ACTION"]) ? '' : $data["IN_".$teamID."H_ACTION"];
}

if($data["SUBMIT_02_".$teamID] == "SUBMIT" OR $data["SUBMIT_02_".$teamID] == "BACK"){
    $comments = "";
    $approval = $data["SUBMIT_02_".$teamID] == "SUBMIT" ? "Approved" : "Back";
}*/
