<?php 
/*********************************
 * PE - Verify approvers response IC02
 *
 * by Telmo Chiri
 ********************************/
...
//Set initial values
$emailsSent = $data["PE_EMAILS_SENT_IC02"] ?? [];
...
if ($totalABERequestsSuccess > 0) {
    ...
    $queryCollectionID = "SELECT data->>'$.COLLECTION_ID' AS ID
                          ...
                          WHERE data->>'$.COLLECTION_NAME' = 'PE_IC_02_APPROVER_RESPONSE' ";
...
$dataReturn["PE_ALL_APPROVERS_IC02_ANSWERED"] = $allApproversAnswered;
$dataReturn["PE_DATE_IC02_APPROVAL"] = $lastCreatedAtDate;
return $dataReturn;