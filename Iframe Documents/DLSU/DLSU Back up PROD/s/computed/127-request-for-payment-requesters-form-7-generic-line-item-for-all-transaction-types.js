...
if(this.transactionTypeCode != undefined){
    ...
    if(type == "CA"){ // Cash Advance
        ...
        var date = this.PLA_date;
        var amount = this.INVOICE_AMOUNT;
        var remarks = this.PLA_remarks;
    
        if(PLA != undefined && date != undefined && amount != undefined && remarks != undefined){
        ...
        var date = this.PSR_date;
        var time = this.PSR_time;
        var mop = this.PSR_modeOfPayment;
        var amount = this.INVOICE_AMOUNT;
        var remarks = this.PSR_remarks;
        
        if(PSR != undefined && date != undefined && time != undefined && mop != undefined && amount != undefined && remarks != undefined){
        ...
        var td = this.RFO_date;
        var cur = this.RFO_currency;
        var amt = this.INVOICE_AMOUNT;
        var rem = this.RFO_remarks;

        if(RFO != undefined && td != undefined && cur != undefined && amt != undefined && rem != undefined){
