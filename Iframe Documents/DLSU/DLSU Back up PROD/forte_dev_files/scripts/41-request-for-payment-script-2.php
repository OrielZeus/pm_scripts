...
$url_attachments = $host_link."requests/" . $data['requestID'] . "/files";
$additional_information = $host_link."requests/" . $data['requestID'];
...
// if(str_contains($invoice_number, "LI") != false){
  ...
  for($x = 0; $x < $array_length; $x++){
    ...
    $item_amount = $payload_record_list[$x]["amount"];
...
else if (strpos($invoice_number, "CA") != false){
