...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-14-33-217"){ // Judith Azcarraga
	choice = "49";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-14-33-222"){ // Divina Amalin 
	choice = "57";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-11-07-060"){ // Christine Abrigo
	choice = "83";
}else if (this.campusChoiceCode == "MC" && this.amountRequested <= 80000 && this.userDept == "2-11-07-060"){
	choice = "84";	
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-11-06-050"){ // Maria Elemos 
	choice = "113";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-11-08-066"){ // Josemari Calleja 
	choice = "121";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-12-12-102"){ // Myla Arcinas
	choice = "171";
...
}else if (this.campusChoiceCode == "LC" && this.amountRequested > 80000 && this.userDept == "2-15-27-275"){ // Imelda Onquit
	choice = "223";
}else if (this.campusChoiceCode == "LC" && this.amountRequested <= 80000 && this.userDept == "2-15-27-275"){
	choice = "224";

}else if (this.campusChoiceCode == "LC" && this.amountRequested > 80000 && this.userDept == "2-15-27-276"){ // Rembrandt Santos
	choice = "225";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-12-10-082"){ // Jocelyn Sales
	choice = "277";
...
}else if (this.campusChoiceCode == "LC" && this.amountRequested > 80000 && this.userDept == "2-15-26-251"){ // Leandro Loyola
	choice = "337";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "1-03-05-029"){ // Leandro Loyola
	choice = "345";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "1-03-05-036"){ // Leandro Loyola
	choice = "349";
}else if (this.campusChoiceCode == "MC" && this.amountRequested <= 80000 && this.userDept == "1-03-05-036"){
	choice = "350";
...
}else if (this.campusChoiceCode == "LC" && this.amountRequested > 80000 && this.userDept == "22-12-11-093"){ // Minie Lapinid
	choice = "367";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 1000000 && this.userDept == "1-01-01-001"){ // Bro Raymundo Suplido // Office of the President
	choice = "391";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-14-33-229"){ // Raymond Tan // CENTRAL INSTRUMENTATION FACILITY
	choice = "415";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-12-12-116"){ // Rhoderick Nuncio // CLA EXTERNAL AFFAIRS OFFICE
	choice = "419";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-12-16-164"){ // Glenn Alea // COS EXTERNAL AFFAIRS OFFICE
	choice = "425";
}else if (this.campusChoiceCode == "MC" && this.amountRequested <= 80000 && this.userDept == "2-12-16-164"){
	choice = "426";

}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-12-16-165"){ // Glenn Alea // COS RESEARCH ADVANCE STUDIES
	choice = "427";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-12-09-073"){ // Judith Azcarraga // DATA SCIENCE INSTITUTE (DSI)
	choice = "431";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "2-12-09-074"){ // Rodiel Ferrer // ENRIQUE RAZON LOGISTICS INSTITUTE (ERLI)
	choice = "453";
...
}else if (this.campusChoiceCode == "LC" && this.amountRequested > 80000 && this.userDept == "2-13-21-182"){ // Gleanson Vines // Office Satellite Campus Facilities Administration - Charles Huang
	choice = "491";
}else if (this.campusChoiceCode == "LC" && this.amountRequested <= 80000 && this.userDept == "2-13-21-182"){
	choice = "492";
...
}else if (this.campusChoiceCode == "MC" && this.amountRequested > 80000 && this.userDept == "1-02-34-312"){ // Ma Inores Palmes // General Accounting
	choice = "521";
}else if (this.campusChoiceCode == "MC" && this.amountRequested <= 80000 && this.userDept == "1-02-34-312"){
	choice = "522";

}else if (this.campusChoiceCode == "LC" && this.amountRequested > 80000 && this.userDept == "2-15-27-265"){ // Ma Inores Palmes // General Accounting
	choice = "523";
